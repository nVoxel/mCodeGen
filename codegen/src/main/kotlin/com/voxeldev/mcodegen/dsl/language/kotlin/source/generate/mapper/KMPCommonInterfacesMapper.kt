...
fun kmpCommonInterfacesMapper(): KMPCommonInterfacesMapper {
    return KMPCommonInterfacesMapper()
}

context(ScenarioScope)
class KMPCommonInterfacesMapper internal constructor(): GenerationMapperBaseImpl() {
