package com.voxeldev.mcodegen.dsl.language.kotlin.utils
...
fun <L, R> Either<L, R>.getRight(): R =
    when (this) {
        is Either.Left -> throw IllegalStateException("Requested Either.getRight(), but it was Left")
        is Either.Right -> b
    }
...
fun <L, R> Either<L, R>.getLeft(): L =
    when (this) {
        is Either.Left -> a
        is Either.Right -> throw IllegalStateException("Requested Either.getLeft(), but it was Right")
    }
